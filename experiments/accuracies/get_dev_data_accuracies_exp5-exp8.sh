...
echo -e "Baseline and bagging accuracies compared (bagging models have different seed in training)\n\n" > dev_data_accuracies_exp5-exp8.txt
echo -e "Baseline high VS exp 4 (10 models, 10 000 sample):\n" >> dev_data_accuracies_exp5-exp8.txt
sdiff baseline_high_accuracies exp5_accuracies >> dev_data_accuracies_exp5-exp8.txt
echo -e "\n" >> dev_data_accuracies_exp5-exp8.txt

echo -e "Baseline high VS exp 5 (100 models, 10 000 sample):\n" >> dev_data_accuracies_exp5-exp8.txt
sdiff baseline_high_accuracies exp6_accuracies >> dev_data_accuracies_exp5-exp8.txt
echo -e "\n" >> dev_data_accuracies_exp5-exp8.txt

echo -e "Baseline medium VS exp 5 (10 models, 1000 sample):\n" >> dev_data_accuracies_exp5-exp8.txt
sdiff baseline_medium_accuracies exp7_accuracies >> dev_data_accuracies_exp5-exp8.txt
echo -e "\n" >> dev_data_accuracies_exp5-exp8.txt

echo -e "Baseline medium VS exp 6 (100 models, 1000 sample):\n" >> dev_data_accuracies_exp5-exp8.txt
sdiff baseline_medium_accuracies exp8_accuracies >> dev_data_accuracies_exp5-exp8.txt
echo -e "\n" >> dev_data_accuracies_exp5-exp8.txt

echo -e "Baseline low:\n" >> dev_data_accuracies_exp5-exp8.txt
cat baseline_low_accuracies >> dev_data_accuracies_exp5-exp8.txt
echo -e "\n" >> dev_data_accuracies_exp5-exp8.txt
