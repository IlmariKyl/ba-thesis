...
echo -e "Baseline and bagging accuracies compared (bagging models have same seed in training)\n\n" > accuracies_same_seed.txt
echo -e "Baseline high VS exp 1 (10 models, 10 000 sample):\n" >> accuracies_same_seed.txt
sdiff baseline_high_accuracies exp1_accuracies >> accuracies_same_seed.txt
echo -e "\n" >> accuracies_same_seed.txt

echo -e "Baseline high VS exp 2 (100 models, 10 000 sample):\n" >> accuracies_same_seed.txt
sdiff baseline_high_accuracies exp2_accuracies >> accuracies_same_seed.txt
echo -e "\n" >> accuracies_same_seed.txt

echo -e "Baseline medium VS exp 3 (10 models, 1000 sample):\n" >> accuracies_same_seed.txt
sdiff baseline_medium_accuracies exp3_accuracies >> accuracies_same_seed.txt
echo -e "\n" >> accuracies_same_seed.txt

echo -e "Baseline medium VS exp 4 (100 models, 1000 sample):\n" >> accuracies_same_seed.txt
sdiff baseline_medium_accuracies exp4_accuracies >> accuracies_same_seed.txt
echo -e "\n" >> accuracies_same_seed.txt

echo -e "Baseline low:\n" >> accuracies_same_seed.txt
cat baseline_low_accuracies >> accuracies_same_seed.txt
echo -e "\n" >> accuracies_same_seed.txt
