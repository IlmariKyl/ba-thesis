...
def main(argv):
	...
	with open(output_dir+'/all_accuracies.txt', 'w') as all_accuracies:
		...
		print("\n{:<40}{:<40}".format("Average accuracy of s1-s"+str(n_basemodels)+" models:", avg_accuracy), file=all_accuracies)
		print("\n{:<56}{:<16}".format("Average accuracy of s1-s"+str(n_basemodels)+" models:", avg_accuracy+"%"))
		print("\n--------------------------------------------------------------\n")
