...
with open("arabic_dev_data_accuracies", "r") as arab_p_acc_file, open("finnish_dev_data_accuracies", "r") as fin_p_acc_file, open("georgian_dev_data_accuracies", "r") as geor_p_acc_file, \
    open("german_dev_data_accuracies", "r") as ger_p_acc_file, open("hindi_dev_data_accuracies", "r") as hin_p_acc_file, open("italian_dev_data_accuracies", "r") as ita_p_acc_file, \
    open("khaling_dev_data_accuracies", "r") as kha_p_acc_file, open("navajo_dev_data_accuracies", "r") as nav_p_acc_file, open("russian_dev_data_accuracies", "r") as rus_p_acc_file, \
    open("turkish_dev_data_accuracies", "r") as tur_p_acc_file, open("voted_dev_data_accuracies", "r") as voted_acc_file, open("weighted_voted_dev_data_accuracies", "r") as weighted_voted_acc_file:
...
fig.savefig("medium_base_dev_data_acc.pdf", bbox_inches='tight')