...
ax0.set_title(r'\textbf{Medium training data}', fontsize=11)

# plt.figure(1, figsize=(30,10))
line0, = ax0.plot(arab_steps, arab_valids, color='blue', linewidth=1, label='Arabic')
line1, = ax0.plot(fin_steps, fin_valids, color='red', linewidth=1, label='Finnish')
line2, = ax0.plot(geor_steps, geor_valids, color='black', linewidth=1, label='Georgian')
line3, = ax0.plot(ger_steps, ger_valids, color='green', linewidth=1, label='German')
line4, = ax0.plot(hin_steps, hin_valids, color='yellow', linewidth=1, label='Hindi')
line5, = ax0.plot(ita_steps, ita_valids, color='lime', linewidth=1, label='Italian')
line6, = ax0.plot(kha_steps, kha_valids, color='orange', linewidth=1, label='Khaling')
line7, = ax0.plot(nav_steps, nav_valids, color='cadetblue', linewidth=1, label='Navajo')
line8, = ax0.plot(rus_steps, rus_valids, color='grey', linewidth=1, label='Russian')
line9, = ax0.plot(tur_steps, tur_valids, color='brown', linewidth=1, label='Turkish')
...
line10, = ax1.plot(arab_steps, arab_perpxs, color='blue', linewidth=1, label='Arabic')
line11, = ax1.plot(fin_steps, fin_perpxs, color='red', linewidth=1, label='Finnish')
line12, = ax1.plot(geor_steps, geor_perpxs, color='black', linewidth=1, label='Georgian')
line13, = ax1.plot(ger_steps, ger_perpxs, color='green', linewidth=1, label='German')
line14, = ax1.plot(hin_steps, hin_perpxs, color='yellow', linewidth=1, label='Hindi')
line15, = ax1.plot(ita_steps, ita_perpxs, color='lime', linewidth=1, label='Italian')
line16, = ax1.plot(kha_steps, kha_perpxs, color='orange', linewidth=1, label='Khaling')
line17, = ax1.plot(nav_steps, nav_perpxs, color='cadetblue', linewidth=1, label='Navajo')
line18, = ax1.plot(rus_steps, rus_perpxs, color='grey', linewidth=1, label='Russian')
line19, = ax1.plot(tur_steps, tur_perpxs, color='brown', linewidth=1, label='Turkish')
...
fig.savefig("devloss_medium_plot.pdf", bbox_inches='tight')